...
impl RoleRepository for PgRoleRepository {
    ...
    async fn get_role_permissions(&self, role_id: Uuid) -> Result<Vec<String>, RepositoryError> {
        let rows = sqlx::query(
    ...
    async fn set_role_permissions(&self, role_id: Uuid, perms: &[String]) -> Result<(), RepositoryError> {
    ...
    async fn get_user_roles(&self, user_id: Uuid) -> Result<Vec<Role>, RepositoryError> {
        let rows = sqlx::query(
    ...
    async fn set_user_roles(&self, user_id: Uuid, role_ids: &[Uuid]) -> Result<(), RepositoryError> {
        let mut tx = self.pool.begin().await.repo()?;
    ...
    async fn get_user_role_codes(&self, user_id: Uuid) -> Result<Vec<String>, RepositoryError> {
        let rows = sqlx::query(
