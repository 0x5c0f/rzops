...
fn to_response(d: &DatabaseInstance) -> DatabaseInstanceResponse {
    DatabaseInstanceResponse { id: d.id, server_id: d.server_id, name: d.name.clone(), db_type: d.db_type.clone(), description: d.description.clone(), status: d.status.clone(), environment: d.environment.clone(), offline_time: d.offline_time, is_self_installed: d.is_self_installed, importance: d.importance.clone(), is_ops_managed: d.is_ops_managed, port: d.port, instance_name: d.instance_name.clone(), created_at: d.created_at, updated_at: d.updated_at, deleted_at: d.deleted_at }
}
