...
pub async fn create_domain(_auth: AuthUser, State(repo): State<Arc<dyn DomainRepository>>, Json(body): Json<CreateDomainRequest>) -> impl IntoResponse {
...
pub async fn update_domain(_auth: AuthUser, State(repo): State<Arc<dyn DomainRepository>>, Path(id): Path<Uuid>, Json(body): Json<UpdateDomainRequest>) -> impl IntoResponse {
...
pub async fn delete_domain(_auth: AuthUser, State(repo): State<Arc<dyn DomainRepository>>, Path(id): Path<Uuid>) -> impl IntoResponse {
