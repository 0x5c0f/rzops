  ...
  <div class="space-y-3">
    ...
    {#if showAdvancedFilter}
      <div class="grid gap-3 rounded-lg border p-4 md:grid-cols-3">
        ...
        <div class="space-y-1">
          <label for="f-2" class="text-xs font-medium text-muted-foreground">IP类型</label>
          <select id="f-2"
            class="w-full rounded-md border px-3 py-2 text-sm"
            value={query.ip_type ?? ''}
            onchange={(e) => {
        ...
        <div class="space-y-1">
          <label for="f-3" class="text-xs font-medium text-muted-foreground">服务器</label>
          <RemoteSearchSelect id="f-3"
